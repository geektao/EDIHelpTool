...
public class SafeProperties extends Properties {
	...
	// public synchronized Object put(PropertyEntry pe) {
...
//	public synchronized Object put(String segment, Object key, Object value) {
//		context.putOrUpdate(key.toString(), value.toString());
//		return super.put(key, value);
//	}
				...
				if (obj instanceof PropertyEntry) {
					if (obj != null) {
						if (key.equals(((PropertyEntry) obj).getKey())) {
							return ((PropertyEntry) obj).getValue();
						}
					}
				}
			}
...
//		public void putOrUpdate(Object segment, String key, String value) {
//		//	boolean flag = false;
//			int num = -1;
//
//			if (commentOrEntrys.contains("#" + segment)) {
//				int ind = commentOrEntrys.indexOf("#" + segment);
//				for (int index = ind; index < commentOrEntrys.size(); index++) {
//					Object obj = commentOrEntrys.get(index);
